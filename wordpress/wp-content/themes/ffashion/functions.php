...
function ffashion_load_scripts() {
	...
	wp_enqueue_script( 'ffashion-js', get_template_directory_uri() . '/js/utilities.js', array( 'jquery' ) );
...
function ffashion_display_social_sites() {
	...
	$socialURL = get_theme_mod('ffashion_social_rss', get_bloginfo( 'rss2_url' ));
	if ( !empty($socialURL) ) {
 ...
 */
function ffashion_show_website_logo_image_or_title() {

	$logoImage = get_theme_mod('ffashion_header_logo', null);
...
function ffashion_widgets_init() {
	...
	/**
	 * Add Homepage Widget area
	 */
	register_sidebar( array (
							'name'			 =>  __( 'Homepage Widget Area', 'ffashion' ),
							'id' 			 =>  'homepage-widget-area',
							'description'	 =>  __( 'The Homepage widget area', 'ffashion' ),
							'before_widget'  =>  '',
							'after_widget'	 =>  '',
...
function ffashion_display_slider() { ?>
	...
	<div class="sequence-theme">
		<div id="sequence">
			<img class="sequence-prev" src="<?php echo get_template_directory_uri(); ?>/images/slider/bt-prev.png" alt="<?php _e( 'Previous Frame', 'ffashion' ); ?>" />
			<img class="sequence-next" src="<?php echo get_template_directory_uri(); ?>/images/slider/bt-next.png" alt="<?php _e( 'Next Frame', 'ffashion' ); ?>" />

			<ul class="sequence-canvas">	
				<?php
					// display slides
					for ( $i = 1; $i <= 3; ++$i ) {
						$defaultSlideContent = __( '<h2 class="title">Lorem ipsum dolor</h2><div class="subtitle"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a title="Read more" href="#">Read more</a></div>', 'ffashion' );
					
						$defaultSlideImage = get_template_directory_uri().'/images/slider/' . $i .'.png';

						$slideContent = get_theme_mod( 'ffashion_slide'.$i.'_content', html_entity_decode( $defaultSlideContent ) );
...
function ffashion_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting(
		...
		array(
		    'default'           => __( '<h2 class="title">Lorem ipsum dolor</h2><div class="subtitle"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p><a title="Read more" href="#">Read more</a></div>', 'ffashion' ),
...
*/
function ffashion_customizer_controls(){

	wp_register_script( 'ffashion_customizer_top_buttons', get_template_directory_uri() . '/js/customizer-top-buttons.js', array( 'jquery' ), true  );
	wp_enqueue_script( 'ffashion_customizer_top_buttons' );

	wp_localize_script( 'ffashion_customizer_top_buttons', 'customBtns', array(
		'prodemo' => esc_html__( 'Demo Premium version', 'ffashion' ),
        'proget' => esc_html__( 'Get Premium version', 'ffashion' )
	) );
}
add_action( 'customize_controls_enqueue_scripts', 'ffashion_customizer_controls' );
