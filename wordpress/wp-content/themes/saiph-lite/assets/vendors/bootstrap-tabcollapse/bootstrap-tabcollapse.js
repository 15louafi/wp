!function ($) {
    ...
    TabCollapse.DEFAULTS = {
        ...
        accordionTemplate: function(heading, groupId, parentId, active){
            return '<div class="panel panel-saiph">' +
    ...
    TabCollapse.prototype._initAccordion = function(){
        this.$accordion = $('<div class="panel-group-saiph ' + this.options.accordionClass + '" id="' + this.$tabs.attr('id') + '-accordion' +'" role="tablist" aria-multiselectable="true"></div>');
